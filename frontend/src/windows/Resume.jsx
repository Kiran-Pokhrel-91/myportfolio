  ...
  return (
    <>
      <div id="window-header">
        <WindowControls
          target={windowKey ?? WINDOW_KEYS.RESUME}
          title="Resume"
        />
        <div className="flex items-center ml-auto mr-3">
          <a
            ...
            download
            className="flex items-center gap-1.5 text-[11px] font-medium px-3 py-1.5 rounded-lg transition-all hover:bg-[var(--panel-text)]/10"
          ...
          loading={
            <div className="flex items-center justify-center py-20">
              <div className="flex flex-col items-center gap-3">
                <div className="size-8 border-2 border-[var(--panel-muted)]/30 border-t-[var(--panel-muted)] rounded-full animate-spin" />
          ...
          error={
            <div className="text-center py-16 space-y-3">
              ...
              <a
                href="/files/resume.pdf"
                download
                className="inline-flex items-center gap-2 text-sm font-medium px-5 py-2.5 rounded-lg transition-all hover:opacity-80"
                style={{
                  backgroundColor:
                    "var(--panel-border)",
